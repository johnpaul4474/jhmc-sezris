...
<template>
  ...
  <div class="bg-white rounded-xl shadow p-6 space-y-8">
    ...
    <div class="border-b pb-4">
        ...
        <h3 variant="default" class="text-lg bg-blue-400 text-white text-center rounded font-semibold mb-2">Application Basic Information</h3>
    ...
    <div>
      <h3 variant="default" class="text-lg  bg-blue-400 text-white rounded text-center font-semibold mb-2">Article Details</h3>
    ...
    <div v-if="props.application.options?.length">
      <h3 variant="default" class="text-lg  bg-blue-400 text-white text-center rounded font-semibold mb-2">Selected Options and Validity Period</h3>
...
<div v-if="props.application.uploads?.length">
  <h3 variant="default" class="text-lg bg-blue-400 text-white text-center rounded font-semibold mb-2">Supporting Document'/s</h3>
  <div v-for="file in props.application.uploads" :key="file.id" class="flex items-center gap-4 border rounded-lg p-3 bg-gray-50">
    ...
    <!-- Approval -->
    <div>
      <h3 variant="default" class="text-lg  text-dark text-center rounded font-semibold mb-2">Approval Info</h3>
      <div class="border rounded-lg p-4 bg-gray-50">
